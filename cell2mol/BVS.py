        ...
        if mol.type == "Complex":
            ...
            for metal in mol.metalist:
                ...
                if metal.coord in mol.coord:
                    ...
                    print(
                        "Possible charge of Metal {}: {}".format(
                            metal.label, get_metal_poscharge(metal.label)
                        )
                    )
                    get_dict = {}
                    for i, charge in enumerate([1, 2, 3]):  # for Cu
                        ...
                        for index in sphere_index:
                            ...
                            if any(
                                ...
                                print(
                                    "OS : +{} Bond : {}-{} S : {}".format(
                                        charge, metal.label, mol.labels[index], S
                                    )
                                )
                        ...
                        if len(S) == len(metal.coord_sphere):
                            ...
                            if mode == "smallest_delta":
                                ...
                                print(
                                    "Trial oxidation state (V_t) of {} is +{}".format(
                                        metal.label, delta + charge
                                    )
                                )
                                delta = abs(delta)
                            else:
                            ...
                            print(
                                "Absolute delta is {} when charge of {} is +{}".format(
                                    delta, metal.label, charge
                                )
                            )
