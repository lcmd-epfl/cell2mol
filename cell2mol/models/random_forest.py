...
print(
    f"Training mean f1_score_micro was {round(np.mean(f1_train_micro), 3)} with STD {round(np.std(f1_train_micro), 3)}"
)
print(
    f"Test mean f1_score_micro was {round(np.mean(f1_test_micro), 3)} with STD {round(np.std(f1_test_micro), 3)}"
)
print(
    f"Training mean f1_score_macro was {round(np.mean(f1_train_macro), 3)} with STD {round(np.std(f1_train_macro), 3)}"
)
print(
    f"Test mean f1_score_macro was {round(np.mean(f1_test_macro), 3)} with STD {round(np.std(f1_test_macro), 3)}"
)
print(
    f"Training mean f1_score_weighted was {round(np.mean(f1_train_weighted), 3)} with STD {round(np.std(f1_train_weighted), 3)}"
)
print(
    f"Test mean f1_score_weighted was {round(np.mean(f1_test_weighted), 3)} with STD {round(np.std(f1_test_weighted), 3)}"
)
