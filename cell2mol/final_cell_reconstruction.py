...
from cell2mol.other import absolute_value, additem, extract_from_list, get_dist
...
def get_fragments_from_moiety(
    ...
    if debug >= 2:
        print(f"get_fragments: updated_moieties_list", updated_moieties_list)
    tmp_blocklist = []
    for idx, updated_moieties in enumerate(updated_moieties_list):
        ...
        if debug >= 2:
            print(f"get_fragments: updated_moieties_labels", updated_moieties_labels)
        if debug >= 2:
            print(
                f"get_fragments: updated_moieties_atom_site_labels",
                updated_moieties_atom_site_labels,
            )
        block = split_species(
