...
class CellData(GeometryObject):
    ...
    Methods:
        ...
        is_spacegroup       : True/False query on crystal system ('cubic', 'trigonal').
                              Also handles 'rhombohedral' correctly.
    ...
    def is_spacegroup(self, type):
        if type == "rhombohedral":
            return self.HallSymbol in Hex2RhombHall
        else:
            return self.crystal_system() == type
